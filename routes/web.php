...
Route::get('/category/{slugs}','BlogController@byCategory')->name('byCategory');
Route::get('/user/{slug}','BlogController@byUser')->name('byUser');
Route::get('/date/{date}','BlogController@byDate')->name('byDate');
